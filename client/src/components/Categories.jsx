...
const Categories = () => {
  ...
  return (
    <div>
      ...
      <UpdateCategoryBox trigger={updateCategory} setTrigger={setUpdateCategory} id={categoryId} />
      <DeleteCategoryBox trigger={deleteCategory} setTrigger={setDeleteCategory} id={categoryId} />
    </div>
  )
}
