...
const Profile = () => {
  ...
  return (
    <div>
      ...
      <UpdateAddressBox trigger={updateAddress} setTrigger={setUpdateAddress} id={addressId} />
      <DeleteAddressBox trigger={deleteAddress} setTrigger={setDeleteAddress} id={addressId} />
    </div>
  )
}
