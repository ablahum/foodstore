...
const Products = () => {
  ...
  return (
    <div>
      ...
      <UpdateProductBox trigger={updateProduct} setTrigger={setUpdateProduct} value={productId} />
      <DeleteProductBox trigger={deleteProduct} setTrigger={setDeleteProduct} value={productId} />
    </div>
  );
};
