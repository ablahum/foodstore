...
//               <BackButton onClick={() => setTrigger(false)} style={{ width: "100%" }}>
//                 BUY SOMETHING
//               </BackButton>
//             ) : (
//               <BackButton onClick={() => loginAlert()} style={{ width: "100%" }}>
//                 BUY SOMETHING
//               </BackButton>
//             )}
//           </div>
//         </div>
//       )}
//       <ConfirmDeleteBox trigger={deleteItem} setTrigger={setDeleteItem} itemName={itemName} value={itemId} />
//     </div>
//   );
// };
